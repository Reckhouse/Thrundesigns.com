...
export function ServicesSection({
  ...
  return (
    <section id="services" className="border-b border-line">
      <div className="mx-auto grid w-full max-w-[1440px] gap-12 px-6 py-16 md:px-10 lg:grid-cols-[420px_1fr] lg:gap-16 lg:px-[74px] lg:py-20">
        <div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {services.map((service) => {
            ...
            return (
              <article
                key={service._id}
                className="flex min-h-[320px] flex-col border border-line bg-surface p-6 lg:min-h-[520px]"
              >
